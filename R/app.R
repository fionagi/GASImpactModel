...
#
#     impModels <- runModel(location, condition = condition, inc = incR,
#                             mortality = mProb, nyears = 85, yearV = yearV,
#                             vaccAge = ageV, vaccEff = overallEff, vaccDur = duration,
#                             impType = impType, pYears = plotYears, initPop = initPop)
#
#     impModels
# })
#
...
#                col.names = TRUE, row.names = TRUE, append = TRUE)
#      write.xlsx(groupResults(impMS[[6]]), file, sheetName = "Deaths_Vacc",
#                col.names = TRUE, row.names = TRUE, append = TRUE)
#     }
#   }
# )
